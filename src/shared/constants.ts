...
export const INITIAL_TEMPLATES: ReferenceTemplate[] = [
  ...
  },
  {
    ...
    version: 'ECI-2023',
    name: 'Election Commission of India Elector Photo Identity Card (EPIC)',
    effectiveDate: '2023-01-01',
    source: 'Election Commission of India Standard',
    isActive: true,
    expectedDimensions: { widthMm: 85.6, heightMm: 54.0, aspectRatio: 1.585 },
    mandatoryFields: ['EPIC No', 'Elector Name', 'Father/Husband Name', 'Gender', 'DOB/Age', 'Address'],
    securityFeaturesExpected: ['Ashoka Lion Emblem', 'Micro-hologram', 'Barcode/QR', 'Official Signature'],
  },
  {
    id: 'TPL-RATION-NFSA',
    documentType: 'OTHER_GOVT_ID',
    version: 'NFSA-2022',
    name: 'National Food Security Act (NFSA) Smart Ration Card',
    effectiveDate: '2022-01-01',
    source: 'State Dept of Food & Civil Supplies',
    isActive: true,
    expectedDimensions: { widthMm: 85.6, heightMm: 54.0, aspectRatio: 1.585 },
    mandatoryFields: ['Ration Card No', 'Head of Family', 'Address', 'Family Members Table', 'FPS Code'],
    securityFeaturesExpected: ['State Department Seal', 'NFSA Logo', 'QR Verification Code', 'Anti-tamper Barcode'],
  },
  {
    id: 'TPL-BIRTH-CERT',
    documentType: 'OTHER_DOCUMENT',
    version: 'RBD-2021',
    name: 'Statutory Birth Certificate (Dept of Public Health)',
    effectiveDate: '2021-01-01',
    source: 'Registration of Births and Deaths Act (RBD)',
    isActive: true,
    expectedDimensions: { widthMm: 210.0, heightMm: 297.0, aspectRatio: 1.414 },
    mandatoryFields: ['Certificate No', 'Child Name', 'Date of Birth', 'Place of Birth', 'Father Name', 'Mother Name'],
    securityFeaturesExpected: ['Emblem of India', 'Municipal / Health Dept Seal', 'Registrar Signature', 'Registration QR'],
  },
  {
    id: 'TPL-MARRIAGE-CERT',
    documentType: 'OTHER_DOCUMENT',
    version: 'SMA-2021',
    name: 'Statutory Marriage Certificate (State Registrar)',
    effectiveDate: '2021-01-01',
    source: 'Special Marriage Act & Compulsory Registration Rule',
    isActive: true,
    expectedDimensions: { widthMm: 210.0, heightMm: 297.0, aspectRatio: 1.414 },
    mandatoryFields: ['Registration No', 'Husband Name', 'Wife Name', 'Date of Marriage', 'Place of Marriage'],
    securityFeaturesExpected: ['State Sovereign Emblem', 'Official Registrar Seal', 'Signatures of Parties', 'Cryptographic Stamp'],
  },
  {
    id: 'TPL-EDU-DEGREE',
    documentType: 'OTHER_DOCUMENT',
    version: 'UGC-NAD-2022',
    name: 'Accredited University Degree / Marksheet Certificate',
    effectiveDate: '2022-01-01',
    source: 'University Grants Commission (UGC) / NAD Standard',
    isActive: true,
    expectedDimensions: { widthMm: 210.0, heightMm: 297.0, aspectRatio: 1.414 },
    mandatoryFields: ['Roll / Reg No', 'Candidate Name', 'Course / Degree', 'Year / Grade', 'University Name'],
    securityFeaturesExpected: ['University Crest / Seal', 'Controller of Examinations Signature', 'Anti-copy Watermark', 'NAD / QR Verification'],
  },
];
